    ...
    return (
        <CreateProjectModal isOpen={isOpen} onChange={onChange} title="Create Project Post">
            <form action="" onSubmit={handleSubmit(onSubmitHandler)} className="flex flex-col gap-y-4">
                ...
                <Input type="text" disabled={isLoading} {...register('description', {required: true})} className="min-h-[100px]" placeholder="Write an overview of your project, purpose, goal and skills." />
                </div>
                <div className="width-auto flex content-center justify-center ">

                <Button className="bg-blue-700 text-white w-auto" type="submit" disabled={isLoading}>Create Project</Button>
                </div>
            </form>
        </CreateProjectModal>
    )
